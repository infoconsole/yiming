...
<div class="easyui-layout" data-options="fit:true">
    <form id="liningff" method="post">
        <div data-options="region:'north'" style="padding:10px;height: 150px">
            <div style="margin-bottom:10px;">
                ...
                <input type="hidden" id="id" name="id" value="${Designs.id}">
                <input id="_lining_code" name="liningcode" class="easyui-textbox"
                       data-options="prompt:'请输入面料编号...',required:true,editable:false" style="width:100%;"
                       value="${Designs.liningcode}">
            </div>
            <div style="margin-bottom:10px;">
    ...
    <div data-options="region:'south',border:false" style="text-align:right;padding:5px;">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
           id="update_des_ok" style="width:80px">保存</a>
        <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)"
           id="update_des_cancel" style="width:80px">取消</a>
    </div>
</div>
<script type="text/javascript">
    ...
    $.parser.onComplete = function () {
        ...
        common.createDataGrid("sj_dg", "/querydesignsfiles.do?desid=" + desid, null,

...
<div class="easyui-layout" data-options="fit:true">
    <form id="visitff" method="post">
        <div data-options="region:'north'" style="padding:10px;height: 150px">
            <div style="margin-bottom:10px;">
                <input type="hidden" id="id" name="id" value="${Visit.id}">
                <label class="label-top">回访照类别编码</label>
                <input id="_visit_code" name="visitcode" class="easyui-textbox"
                       data-options="prompt:'请输入类别编码...',required:true,editable:false" style="width:100%;"
                       value="${Visit.visitcode}">
                <label class="label-top">回访照类别</label>
    ...
    <div data-options="region:'south',border:false" style="text-align:right;padding:5px;">
        <a class="easyui-linkbutton" data-options="iconCls:'icon-ok'" href="javascript:void(0)"
           id="update_vi_ok" style="width:80px">保存</a>
        <a class="easyui-linkbutton" data-options="iconCls:'icon-cancel'" href="javascript:void(0)"
           id="update_vi_cancel" style="width:80px">取消</a>
    </div>
</div>
<script type="text/javascript">
    ...
    $.parser.onComplete = function () {
        ...
        common.createDataGrid("vi_dg", "/queryvisitfiles.do?visitid=" + visitid, null,
            null, mainGridParam, false);
        ...
        $("#update_vi_ok").click(function () {
                $.messager.confirm("提示信息", "确定要保存信息码", function (r) {
                    if (r) {
                        ...
                        var rdata = {
                            id: $("#id").val(),
                            visitcode: $("#_visit_code").textbox("getValue"),
                            visitname: $("#_visit_name").textbox("getValue"),
                            visitlist: JSON.stringify(sjRowsData)
                        }
                        ajaxUtil.post("/updatevisits.do", rdata, false, function (data) {
                            if (data.status == 1) {
                                common.loadDateGrid("visit_dg")//刷新主页面到第一页
                                common.closeWin("updateViWin");
        ...
        //取消按钮监听
        $("#update_vi_cancel").click(function () {
            common.closeWin("updateViWin");
        });
    }
